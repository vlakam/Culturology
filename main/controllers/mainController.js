  ...
  angular
    ...
    .controller('mainController', function(leafletData, $window) {
      ...
      vm.ages = [{
        ...
        buildings: [{
            name: 'Зимний дворец',
            desc: 'Зи́мний дворец Петра́ I — личная резиденция императора Петра I, возведённая на набережной Невы у Зимней канавки, архитектурно-мемориальный памятник архитектуры начала XVIII века, частично сохранившийся и находящийся в здании Эрмитажного театра, включён в музейный комплекс Государственного Эрмитажа.',
            ...
            name: 'Летний сад',
            desc: 'Летний сад— парковый ансамбль, памятник садово-паркового искусства первой трети XVIII века в Центральном районе Санкт-Петербурга. Сад был заложен по повелению Петра I в 1704 году и первоначально был регулярным.',
          ...
          {
            name: 'Домик Петра I',
            desc: 'Домик Петра I — первая постройка в Санкт-Петербурге, летнее жилище царя Петра I в период с 1703 по 1708 годы. Этот небольшой деревянный домик площадью 60 м² был построен солдатами-плотниками недалеко от Троицкой площади всего за три дня — 13 (24) мая по 15 (26) мая 1703. Здесь же 16 (27) мая прошло празднование по случаю присоединения земель и основания нового города.',
          ...
          },
          {
            ...
            desc: 'Здание Главного Адмиралтейства — комплекс адмиралтейских построек в Санкт-Петербурге на 2-м Адмиралтейском острове, расположенный на берегу реки Нева, значительный памятник архитектуры русского ампира. Изначально построенный в качестве верфи, подвергался перестройке в XVIII—XIX веках.',
          ...
          {
            name: 'Кикины палаты',
            desc: 'Кикины палаты — памятник архитектуры петровского барокко, находящийся в Санкт-Петербурге по адресу Ставропольская улица, дом 9.',
          ...
          },
          {
            ...
            desc: 'Здание Двенадцати коллегий — здание на Университетской набережной Васильевского острова в Санкт-Петербурге, выстроенное в 1722—1742 гг. для размещения петровских коллегий. Крупнейший по размерам памятник петровского барокко состоит из двенадцати идентичных трёхэтажных секций.',
          ...
          },
          {
            ...
            desc: 'Меншиковский дворец (филиал Эрмитажа — дворец Меншикова, в реестре культурных памятников — дворец Меншикова А. Д.) — построенный для приближенного императора Петра Первого, первого губернатора Санкт-Петербурга Александра Даниловича Меншикова, дворец выполнен в стиле петровского барокко, первое каменное здание Санкт-Петербурга. Авторы проекта — приглашённые зодчие Д. М. Фонтана и Г. И. Шедель.',
            image: 'https:/w/extensions/FlaggedRevs/frontend/modules/img/1.png',
          ...
          },
          {
            ...
            desc: 'Летний дворец Петра I — название сохранившейся до наших дней в первозданном виде резиденции Петра I в Летнем саду Санкт-Петербурга. Используется как музей (филиал Русского музея). В настоящее время закрыт на реставрацию и для посещения не доступен. Обновлённый дворец откроется в 2017 году.',
        ...
        buildings: [{
          name: 'Кунсткамера',
          desc: 'Кунсткамера — кабинет редкостей, в настоящее время — Музей антропологии и этнографии имени Петра Великого Российской академии наук (МАЭ РАН) — первый музей России, учреждённый императором Петром Первым и находящийся в Санкт-Петербурге.',
        ...
        buildings: [{
          ...
          desc: 'Церковь Симеона и Анны (официальное название — церковь святых и праведных Симеона Богоприимца и Анны Пророчицы) — действующая православная церковь в Санкт-Петербурге, находящаяся на углу улицы Белинского и Моховой улицы, памятник архитектуры, один из старейших храмов Санкт-Петербурга. Церковь являлась капитульным храмом ордена Святой Анны.',
        ...
        buildings: [{
          name: 'Ани́чков дворец',
          desc: 'Ани́чков дворец— один из императорских дворцов Санкт-Петербурга, у Ани́чкова моста на набережной реки Фонта́нки (Невский проспект, 39). Своё название дворец получил от Ани́чкова моста (см. Ани́чковы). Старейшее из сохранившихся зданий на Невском проспекте.',
          ...
          desc: 'Невские ворота — ворота Петропавловской крепости в Санкт-Петербурге, находящиеся в Невской куртине между Государевым и Нарышкиным бастионами. Соединяют крепость с Комендантской пристанью. Памятник архитектуры классицизма.',
          ...
          desc: 'Дворцовая набережная Невы в центре Санкт-Петербурга находится по левому берегу от Набережной Кутузова до Адмиралтейской набережной. На набережной расположены здания Государственного Эрмитажа, Русского музея и пр.',
        ...
        buildings: [{
          ...
          desc: 'Здание Главного штаба — историческое здание, располагающееся на Дворцовой площади в Санкт-Петербурге. Строительство здания продолжалось с 1819 по 1829 год. Архитектор: К. И. Росси. Скульпторы: С. С. Пименов, В. И. Демут-Малиновский.',
        ...
        buildings: [{
          ...
          desc: 'Александровская колонна — памятник в стиле ампир, находящийся в центре Дворцовой площади Санкт-Петербурга. ',
          ...
          name: 'Александровская колонна',
          desc: 'Здание Главного штаба — историческое здание, располагающееся на Дворцовой площади в Санкт-Петербурге',
          ...
          desc: 'Дворцовая площадь — главная площадь Санкт-Петербурга, архитектурный ансамбль, возникший во второй половине XVIII — первой половине XIX века',
          image: 'http://www.saint-petersburg.com/images/history/st-petersburg-in-the-era-of-nicholas-i/part-of-the-panorama-of-palace-square-general-staff-building.jpg',
          ...
          desc: 'Здания Сената и Синода — памятник архитектуры — здания в стиле позднего классицизма, расположенные на Сенатской площади в Санкт-Петербурге. Возведены в 1829–1834 годах. Соединены триумфальной аркой, перекинутой над Галерной улицей.',
          ...
          desc: 'Александринский театр — русский петербургский театр, один из старейших драматических театров России, сохранившихся до нашего времени.',
          ...
          desc: 'Российская национальная библиотека — одна из первых публичных библиотек в Восточной Европе, расположена в Санкт-Петербурге.',
        ...
        buildings: [{
          ...
          },
          {
            ...
            desc: 'Исаакиевский собо́р (официальное название — собор преподо́бного Исаа́кия Далма́тского) — крупнейший православный храм Санкт-Петербурга. Расположен на Исаакиевской площади. Имеет статус музея (музейный комплекс «Государственный музей-памятник „Исаакиевский собор“»).',
          ...
          },
          {
            ...
            desc: 'Большой Санкт-Петербургский государственный цирк (также широко используется историческое название Цирк Чинизелли) — цирк города Санкт-Петербурга, первый каменный стационарный цирк России, один из старейших цирков России.',
        ...
        buildings: [{
            name: 'Спас на Крови',
            desc: 'Собор Воскресения Христова на Крови, или храм Спаса на Крови в Санкт-Петербурге — православный мемориальный однопрестольный храм во имя Воскресения Христова; сооружён в память того, что на этом месте 1(13) марта 1881 года в результате покушения был смертельно ранен император Александр II (выражение на крови указывает на кровь царя). Храм был сооружён как памятник царю-мученику на средства, собранные по всей России.',
          ...
          {
            name: 'Кресты',
            desc: '«Кресты» — следственный изолятор в Петербурге, один из наиболее известных и крупных в России. Официальное название — Федеральное казённое учреждение «Следственный изолятор № 1»',
        ...
        buildings: [{
          ...
          },
          {
            ...
            desc: 'Дом компании «Зи́нгер» (известный также как «Дом книги») — здание в Санкт-Петербурге, расположенное по адресу Невский проспект, дом 28, памятник архитектуры федерального значения, находится в государственной собственности.',
